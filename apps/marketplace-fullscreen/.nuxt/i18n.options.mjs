...
{ key: "../lang/en-US.json", load: () => import("../lang/en-US.json" /* webpackChunkName: "locale__Users_mac_Documents_GitHub_GovernanceDao_apps_marketplace_fullscreen_lang_en_US_json" */), cache: true }]
}
