...
VList(pos="relative" ref="element")
  HList(font="bold" frame="~ gray-400" color="white" h="10" px="3" justify="between" items="center" cursor="pointer" space-x="3" @click="isOpen = !isOpen" )
  ...
  Transition(name="fade")
    div(frame="~ gray-400" mt="2" v-if="isOpen" pos="!absolute top-full right-0" min-w="80" font="bold")
