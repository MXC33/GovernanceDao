<template lang="pug">
HList(cut="top-right s-xs b-gray-600 hover:b-gray-500 md:(top-right s-sm b-gray-600 hover:(b-gray-500))" bg="gray-600 hover:gray-500" items="center" space-x="4" px="3" py="2" cursor="pointer" @click="toggle" :selected="isSelected" group v-if="isSelected")
