...
Transition(name="slide-left")
  HList(v-if="numberOfSelected" w="full" bg="ix-black" pos="sticky top-36 on-table:sticky top-30" z="3" px="0 on-open:3" flex-wrap="~" space-x="4" :open="isOpen" :active="isFilterActive" :table="isTable" gap="0.5" p="b-0 on-active:b-3")
