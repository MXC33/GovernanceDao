...
Transition(name="slide-left")
  HList(v-if="numberOfSelected" w="md:!full" mx="lt-md:(-4)" bg="ix-black" pos="sticky top-40 on-table:sticky top-30" z="3" px="0 on-open:3" whitespace="nowrap" flex-wrap="~" :open="isOpen" :active="isFilterActive" gap="3" p="l-4 r-4 md:l-0 r-0 on-active:b-4 md:b-3")
