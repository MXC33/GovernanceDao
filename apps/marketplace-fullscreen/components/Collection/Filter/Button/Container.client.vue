...
Transition(name="slide-left")
  HList(v-if="numberOfSelected" flex-wrap="~" gap="3" p="l-4 r-4 md:l-0 r-0 on-active:b-4 md:b-3" w="md:full" mx="lt-md:(-4)" bg="ix-black" px="0 on-open:3" whitespace="nowrap" :open="isOpen" :active="isFilterActive")
