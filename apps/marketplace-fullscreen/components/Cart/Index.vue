...
Transition(name="slide-right")
  div(pos="fixed right-0 top-0 bottom-0" overflow-y="auto" bg="ix-black" w="80 md:120" max-w="80%" z="200" color="white" space-y="5" py="6" ref="cartElement" v-if="viewingCart")
