...
export type ContractContext = EthersContractContextV5<
  LootCrate,
  LootCrateMethodNames,
  LootCrateEventsContext,
  LootCrateEvents
>;
...
export type LootCrateEvents = 'ChestOpened' | 'OwnershipTransferred';
export interface LootCrateEventsContext {
  ChestOpened(...parameters: any): EventFilter;
  OwnershipTransferred(...parameters: any): EventFilter;
}
export type LootCrateMethodNames =
  | 'chestTokenId'
  | 'fulfillRandomWords'
  | 'initialize'
  | 'openChests'
...
export interface LootCrate {
   ...
   * StateMutability: nonpayable
   * Type: function
   * @param _vrf Type: address, Indexed: false
   */
  setVRF(
    _vrf: string,
    overrides?: ContractTransactionOverrides
