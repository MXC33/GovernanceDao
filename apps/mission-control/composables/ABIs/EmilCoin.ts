...
export type EmilCoinEvents = 'Approval' | 'Transfer';
export interface EmilCoinEventsContext {
  Approval(...parameters: any): EventFilter;
  Transfer(...parameters: any): EventFilter;
}
export type EmilCoinMethodNames =
  | 'new'
  | 'allowance'
  | 'approve'
  | 'approveInternal'
...
export interface EmilCoin {
   ...
   * @param initialAccount Type: address, Indexed: false
   * @param initialBalance Type: uint256, Indexed: false
   */
  'new'(
    name: string,
    symbol: string,
