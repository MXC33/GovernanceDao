...
export type ContractContext = EthersContractContextV5<
  ISuperToken,
  ISuperTokenMethodNames,
  ISuperTokenEventsContext,
  ISuperTokenEvents
>;
...
export type ISuperTokenEvents =
  ...
  | 'TokenUpgraded'
  | 'Transfer';
export interface ISuperTokenEventsContext {
...
export type ISuperTokenMethodNames =
  | 'allowance'
  | 'approve'
  | 'authorizeOperator'
  | 'balanceOf'
