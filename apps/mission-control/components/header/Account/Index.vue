    ...
    VList(b="l-1 ix-orange opacity-40" flex-grow="1")
      ...
      HList(flex-grow="1" items="center")
        HList(b="r-1 ix-orange opacity-40" p="2" flex-grow="1" h="full" items="center" space-x="1" font="bold")
          div(text="gray") IXT: 
          div(text="ix-mint") {{ formattedIXTBalance }}
...
import AOCIcon from '~/assets/images/ui/user/user-profile.svg?component'
import PlusIcon from '~/assets/images/ui/plus.svg?component'
...
const { formattedIXTBalance } = useCurrencyData()
