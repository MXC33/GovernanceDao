...
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, readBody, getQuery as getQuery$1, createError } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/devalue/index.js';
...
import { klona } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/klona/dist/index.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/ufo/dist/index.mjs';
...
import { GraphQLClient } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/graphql-request/build/esm/index.js';
    ...
    "graphql-client": {
      "clients": {
        "default": {
          ...
          "host": "https://mission-control-api-stage-syfs2.ondigitalocean.app/graphql"
        }
      }
    },
...
const serverAssets = [{"baseName":"server","dir":"/Users/isakburstrom/dev/ix-apps/apps/mission-control/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/isakburstrom/dev/ix-apps/apps/mission-control","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/isakburstrom/dev/ix-apps/apps/mission-control/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/isakburstrom/dev/ix-apps/apps/mission-control/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/isakburstrom/dev/ix-apps/apps/mission-control/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const config = {"default":{"token":{"type":"Bearer","name":"Authorization"},"proxyCookies":true,"tokenStorage":{"mode":"cookie","cookieOptions":{"maxAge":604800,"secure":false},"name":"gql:default"},"preferGETQueries":false,"schema":"/Users/isakburstrom/dev/ix-apps/apps/mission-control/schema.graphql","host":"https://mission-control-api-stage-syfs2.ondigitalocean.app/graphql"}};
const clients = {};
...
const _lazy_bcGuto = () => Promise.resolve().then(function () { return cachebust_post$1; });
const _lazy_Swp7cu = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/cachebust', handler: _lazy_bcGuto, lazy: true, middleware: false, method: "post" },
...
const cachebust_post = defineEventHandler(async (event) => {
...
const cachebust_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: cachebust_post
});
...
const getClientManifest = () => import('/Users/isakburstrom/dev/ix-apps/apps/mission-control/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/isakburstrom/dev/ix-apps/apps/mission-control/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
