<template lang="pug">
div(w="full" p="4 b-0" bg="ix-pink opacity-10" b="1 ix-pink" rounded="2xl")
  HList(color="ix-white" text="3xl md:4xl xl:5xl" uppercase="~" font="bdrA3mik" class="-mr-4 -ml-4 -mt-4" p="x-4 t-4 b-2" cursor="pointer" @click.stop="dropDrawer")
    span(m="r-8") How to play
    IconChevronBold(w="5" :up="isOpen" m="b-1")
  Transition(name="slide-top")
    Collapse(:when="isOpen" class="v-collapse" overflow-y="auto" )
      VList(flex="~ col lg:row wrap" items="start" justify="between" gap-y="10" m="t-2 b-7")
