...
Transition(name="fade" appear)
  VList(pos="fixed" inset="0" bg="black opacity-80" w="full" h="full" :z="isError ? '910' : '900'" items="center" justify="center" @click="onClose" backdrop-blur-sm)
    ...
    VList(w="full" pos="relative" @click.stop="" :bg="isError ? '$mc-error' : 'ix-pink opacity-60'" m="auto" z="1000" max-w="150" min-h="415px" color="white" h="lt-md:full" max-h="md:90%" overflow-y="auto" overflow-x="lt-md:hidden" rounded="2xl"  :b="isError ? '$mc-error' : '1 ix-white'" )
