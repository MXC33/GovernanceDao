...
const { loading: isLoadingStake, execute: stakeRequest } = useContractRequestFnd(() => stake(), 'stake')

const { loading: isLoadingUnstake, execute: unstakeRequest } = useContractRequestFnd(() => unstake(), 'unstake')
