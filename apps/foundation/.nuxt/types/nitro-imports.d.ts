declare global {
  const GqlAllLandmarks: typeof import('#gql-nitro')['GqlAllLandmarks']
...
export { GqlAllLandmarks, GqlAllUserTerritories, GqlAuthed, GqlAvatarNFT, GqlCatRaffAccounts, GqlCatRaffPastPrizes, GqlCatRaffTransactions, GqlCatRaffWeekly, GqlCurrencies, GqlEthNFTs, GqlGeoLotteryNFT, GqlLand, GqlLandmarks, GqlRovers, GqlStakingData, GqlTokenInfo, GqlTokenInfoTypeTier, GqlTokens, GqlTotalFacilitiesMinted, GqlUniqueLandWithInfo, GqlUniquePixWithInfoFromId, GqlUserIxtTransactions, GqlBadgeNFT } from '#gql-nitro';
