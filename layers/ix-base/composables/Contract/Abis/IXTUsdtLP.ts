...
export type ContractContext = EthersContractContextV5<
  IXTUsdtLP,
  IXTUsdtLPMethodNames,
  IXTUsdtLPEventsContext,
  IXTUsdtLPEvents
>;
...
export type IXTUsdtLPEvents =
  ...
  | 'Sync'
  | 'Transfer';
export interface IXTUsdtLPEventsContext {
...
export type IXTUsdtLPMethodNames =
  | 'new'
  | 'DOMAIN_SEPARATOR'
  | 'MINIMUM_LIQUIDITY'
  | 'PERMIT_TYPEHASH'
