...
export type ContractContext = EthersContractContextV5<
  IXTUsdtStaking,
  IXTUsdtStakingMethodNames,
  IXTUsdtStakingEventsContext,
  IXTUsdtStakingEvents
>;
...
export type IXTUsdtStakingEvents =
  ...
  | 'Unpaused'
  | 'Withdrawn';
export interface IXTUsdtStakingEventsContext {
...
export type IXTUsdtStakingMethodNames =
  | 'balanceOf'
  | 'earned'
  | 'exit'
  | 'getReward'
...
export interface IXTUsdtStaking {
  /**
   * Payable: false
   * Constant: true
