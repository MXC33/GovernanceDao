...
export type ContractContext = EthersContractContextV5<
  IXTStaking,
  IXTStakingMethodNames,
  IXTStakingEventsContext,
  IXTStakingEvents
>;
...
export type IXTStakingEvents =
  ...
  | 'Unpaused'
  | 'Withdrawn';
export interface IXTStakingEventsContext {
...
export type IXTStakingMethodNames =
  | 'balanceOf'
  | 'earned'
  | 'exit'
  | 'getReward'
