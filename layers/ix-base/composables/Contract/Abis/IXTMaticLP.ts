...
export type ContractContext = EthersContractContextV5<
  IXTMaticLP,
  IXTMaticLPMethodNames,
  IXTMaticLPEventsContext,
  IXTMaticLPEvents
>;
...
export type IXTMaticLPEvents =
  ...
  | 'Sync'
  | 'Transfer';
export interface IXTMaticLPEventsContext {
...
export type IXTMaticLPMethodNames =
  | 'new'
  | 'DOMAIN_SEPARATOR'
  | 'MINIMUM_LIQUIDITY'
  | 'PERMIT_TYPEHASH'
