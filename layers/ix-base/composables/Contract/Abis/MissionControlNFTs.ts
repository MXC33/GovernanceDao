...
export type ContractContext = EthersContractContextV5<
  MissionControlNFTs,
  MissionControlNFTsMethodNames,
  MissionControlNFTsEventsContext,
  MissionControlNFTsEvents
>;
...
export type MissionControlNFTsEvents =
  | 'ApprovalForAll'
  | 'Minted'
  | 'MintedHigherTier'
  | 'MintedTo'
  ...
  | 'TransferSingle'
  | 'URI';
export interface MissionControlNFTsEventsContext {
...
export type MissionControlNFTsMethodNames =
  | 'airdrop'
  | 'balanceOf'
  | 'balanceOfBatch'
  | 'exists'
...
export interface MissionControlNFTs {
  /**
   * Payable: false
   * Constant: false
