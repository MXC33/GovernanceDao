...
div()
  HList(group p="3")
    ...
    HeaderDetailsIcon(:title="subHeaderObject.title")
    VList( )
      div(color="white group-hover:$mc-orange" text="16px" ) {{subHeaderObject.title}} 
      div(color="gray-200 group-hover:$mc-orange" ) {{ subHeaderObject.description }}
</template>
