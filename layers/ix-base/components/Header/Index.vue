...
Transition(name="slide-top" mode="out-in")
  HeaderDesktop(:class="className + '-desktop'" v-if="activeMenuIndex != null" :key="activeMenuIndex" :header="siteTopHeaders[activeMenuIndex]" display="lt-lg:none" @onClickItem="")

Transition(name="slide-top" )
  HeaderMobile(:class="className + '-mobile'" v-if="activeMenuIndex != null" overflow-y="auto" display="lg:none" @close="toggleMenu")
