...
const WalletConnectLogo = await import(
  "../../../assets/images/wallet/walletconnect.svg"
);
const CryptoDefiLogo = await import(
  "../../../assets/images/wallet/crypto-defi.svg"
);
...
const isConnectorAvailable = computed(
  () => getConnectorName(props.connector) != null,
);
const isActive = (connector: WalletConnector) =>
