...
export default definePreset({
  ...
  shortcuts: [
    ...
    {
      'btn': 'transition-all transition-duration-100 flex flex-col text-center justify-center items-center leading-none cursor-pointer font-bold uppercase min-h-12 px-4',
      'btn-lg': 'min-h-14',
      'btn-md': 'min-h-10',
      'btn-center': 'flex justify-center items-center',
      'btn-solid': 'btn btn-lg lg:px-8',
