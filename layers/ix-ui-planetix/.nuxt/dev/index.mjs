globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/isakburstrom/dev/ix-apps/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, readBody, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/radix3/dist/index.mjs';
import { GraphQLClient } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/graphql-request/dist/index.js';
import { generateJSON } from 'file:///Users/isakburstrom/dev/ix-apps/node_modules/@intlify/bundle-utils/index.mjs';
...
const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false}}},"public":{"graphql-client":{"clients":{"default":{"token":{"type":"Bearer","name":"Authorization"},"proxyCookies":true,"tokenStorage":{"mode":"cookie","cookieOptions":{"maxAge":604800,"secure":false},"name":"gql:default"},"preferGETQueries":false,"schema":"/Users/isakburstrom/dev/ix-apps/layers/ix-base/schema.graphql","host":"https://api-mc.planetix.com/graphql"}}},"i18n":{"experimental":{"jsTsFormatResource":false},"baseUrl":""}},"graphql-client":{"clients":{}},"i18n":{"precompile":{"strictMessage":true,"escapeHtml":false}}};
...
const serverAssets = [{"baseName":"server","dir":"/Users/isakburstrom/dev/ix-apps/layers/ix-ui-planetix/server/assets"}];
...
storage.mount('i18n', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/isakburstrom/dev/ix-apps/layers/ix-ui-planetix/.nuxt/i18n","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/isakburstrom/dev/ix-apps/layers/ix-ui-planetix","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/isakburstrom/dev/ix-apps/layers/ix-ui-planetix/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/isakburstrom/dev/ix-apps/layers/ix-ui-planetix/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/isakburstrom/dev/ix-apps/layers/ix-ui-planetix/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const config = {"default":{"token":{"type":"Bearer","name":"Authorization"},"proxyCookies":true,"tokenStorage":{"mode":"cookie","cookieOptions":{"maxAge":604800,"secure":false},"name":"gql:default"},"preferGETQueries":false,"schema":"/Users/isakburstrom/dev/ix-apps/layers/ix-base/schema.graphql","host":"https://api-mc.planetix.com/graphql"}};
const clients = {};
const GqlNitro = { clients, config };

const _hH3rQTQ8O6 = defineNitroPlugin(() => {
...
const _g5BbNh = defineEventHandler(async (event) => {
...
const _lazy_Swp7cu = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_Swp7cu, lazy: true, middleware: false, method: undefined },
  { route: '/__i18n__/precompile', handler: _g5BbNh, lazy: false, middleware: false, method: "post" },
  { route: '/**', handler: _lazy_Swp7cu, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/Users/isakburstrom/dev/ix-apps/layers/ix-ui-planetix/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/isakburstrom/dev/ix-apps/layers/ix-ui-planetix/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
